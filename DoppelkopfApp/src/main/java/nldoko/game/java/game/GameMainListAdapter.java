...
class GameMainListAdapter extends ArrayAdapter<RoundClass> {


    private final Context mContext;
    private final ArrayList<RoundClass> mRounds;
    private final GameClass mGame;
    private final LayoutInflater mInflater;
    private final RoundNumberLongClickListerner mRoundNrLongListerner;
